...
/*
/home/user/output-audio-stream/cmake-build-default/audio/streamsome_audio_pulseaudio-device-list
=======[ Output Device #1 ]=======
...
void pa_sinklist_cb(pa_context *c, const pa_sink_info *l, int eol, void *userdata) {
    pa_devicelist_t *pa_devicelist = static_cast<pa_devicelist_t *>(userdata);
    int ctr = 0;
